...
class MoviesUpcomingFragment : Fragment(), OpensMovieDetails {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this).get(MoviesUpcomingViewModel::class.java)
    }
    ...
    private fun setUpRecyclerView() {
        moviesUpcomingRecycler.layoutManager = LinearLayoutManager(context)
        moviesUpcomingRecycler.adapter = movieAdapter
        moviesUpcomingRecycler.addOnScrollListener(object : RecyclerView.OnScrollListener() {
