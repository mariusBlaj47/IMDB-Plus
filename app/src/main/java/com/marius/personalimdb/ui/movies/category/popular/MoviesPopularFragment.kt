...
class MoviesPopularFragment : Fragment(), OpensMovieDetails {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this).get(MoviesPopularViewModel::class.java)
    }
    ...
    private fun setUpRecyclerView() {
        moviesPopularRecycler.layoutManager = LinearLayoutManager(context)
        moviesPopularRecycler.adapter = movieAdapter
        moviesPopularRecycler.addOnScrollListener(object : RecyclerView.OnScrollListener() {
