...
import kotlinx.android.synthetic.main.fragment_tv_shows_upcoming.*

class TvShowsUpcomingFragment : Fragment(), OpensTvShowDetails {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this).get(TvShowsUpcomingViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tv_shows_upcoming, container, false)
    }
    ...
    private fun setUpRecyclerView() {
        tvShowsUpcomingRecycler.layoutManager = LinearLayoutManager(context)
        tvShowsUpcomingRecycler.adapter = tvShowAdapter
        tvShowsUpcomingRecycler.addOnScrollListener(object : RecyclerView.OnScrollListener() {
