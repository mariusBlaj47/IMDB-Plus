...
class MoviesTopFragment : Fragment(), OpensMovieDetails {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this).get(MoviesTopViewModel::class.java)
    }
    ...
    private fun setUpRecyclerView() {
        moviesNowPlayingRecycler.layoutManager = LinearLayoutManager(context)
        moviesNowPlayingRecycler.adapter = movieAdapter
        moviesNowPlayingRecycler.addOnScrollListener(object : RecyclerView.OnScrollListener() {
