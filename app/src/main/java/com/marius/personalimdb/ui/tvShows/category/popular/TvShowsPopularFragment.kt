package com.marius.personalimdb.ui.tvShows.category.popular
...
class TvShowsPopularFragment : Fragment(), OpensTvShowDetails {
    ...
    private val viewModel by lazy {
        ViewModelProviders.of(this).get(TvShowsPopularViewModel::class.java)
    }
    ...
    private fun setUpRecyclerView() {
        tvShowsPopularRecycler.layoutManager = LinearLayoutManager(context)
        tvShowsPopularRecycler.adapter = tvShowAdapter
        tvShowsPopularRecycler.addOnScrollListener(object : RecyclerView.OnScrollListener() {
